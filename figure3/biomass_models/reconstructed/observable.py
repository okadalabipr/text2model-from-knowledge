        ...
        for i, condition in enumerate(self.conditions):
            ...
            if sol is None:
                ...
                self.simulations[self.obs_names.index('Total_phosphorylated_Shc'), i] = (
                    (sol.y[V.RShP] + sol.y[V.RShGS] + sol.y[V.ShP] + sol.y[V.ShG] + sol.y[V.ShGS]) / (sol.y[V.RShP] + sol.y[V.RShGS] + sol.y[V.ShP] + sol.y[V.ShG] + sol.y[V.ShGS] + sol.y[V.Shc] + sol.y[V.RSH])
                )
                self.simulations[self.obs_names.index('Total_Grb2_bound_to_Shc'), i] = (
                    (sol.y[V.ShG] + sol.y[V.RShGS] + sol.y[V.ShGS]) / (sol.y[V.ShG] + sol.y[V.RShGS] + sol.y[V.ShGS] + sol.y[V.Grb2] + sol.y[V.RG] + sol.y[V.RGS] + sol.y[V.GS])
                )
                self.simulations[self.obs_names.index('Total_Grb2_bound_to_EGFR'), i] = (
                    (sol.y[V.RG] + sol.y[V.RGS] + sol.y[V.RShGS]) / (sol.y[V.ShG] + sol.y[V.RShGS] + sol.y[V.ShGS] + sol.y[V.Grb2] + sol.y[V.RG] + sol.y[V.RGS] + sol.y[V.GS])
                )
                ...
                self.simulations[self.obs_names.index('Total_phosphorylated_EGFR'), i] = (
                    2 * (sol.y[V.RP] + sol.y[V.RPL] + sol.y[V.RPLP] + sol.y[V.RG] + sol.y[V.RGS] + sol.y[V.RSH] + sol.y[V.RShP] + sol.y[V.RShGS]) / (sol.y[V.EGFR] + sol.y[V.Ra] + 2 * (sol.y[V.R2] + sol.y[V.RP] + sol.y[V.RPL] + sol.y[V.RPLP] + sol.y[V.RG] + sol.y[V.RGS] + sol.y[V.RSH] + sol.y[V.RShP] + sol.y[V.RShGS]))
                )
