...
class DifferentialEquation(ReactionNetwork):
    ...
    def diffeq(self, t, y, *x):
        ...
        dydt[V.GS] = + v[11] - v[12] + v[23] - v[24]
        dydt[V.Shc] = - v[13] + v[16]
        dydt[V.RSh] = + v[13] - v[14]
        dydt[V.RShP] = + v[14] - v[15] - v[17] - v[24]
        dydt[V.ShP] = + v[15] - v[16] - v[21] + v[23]
        dydt[V.RShG] = + v[17] - v[18] - v[19]
        dydt[V.ShG] = + v[18] + v[21] - v[22]
        dydt[V.RShGS] = + v[19] - v[20] + v[24]
